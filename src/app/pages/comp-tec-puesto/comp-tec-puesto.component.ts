...
addCompTecPuestos(compTecPuesto:NgForm){
 ...
 if (compTecPuesto.value.compTecObs === this.compTecPuestos[i].puesto) {
...
this.compTecObsU = compTecPuesto.puesto
this.competenciaTecnicaU = compTecPuesto.compTecObs
