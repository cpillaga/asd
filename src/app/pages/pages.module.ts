...
@NgModule({
  declarations: [
    ...
    ConocimientoAdicionalComponent, 
    ActividadEsencialComponent, 
    ActividadCargoComponent, 
    PuestoAddComponent, 
    ExperienciaComponent, 
    ExperienciaPuestoComponent, 
    CompetenciaTecnicaComponent, 
    CompetenciaConductualComponent, 
    CTcomportamientoObsComponent, 
    CccomportamientoObsComponent, 
    CompTecPuestoComponent, 
    CompCondPuestoComponent
  ],
